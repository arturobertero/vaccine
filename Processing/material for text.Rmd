...
## Predictors with references (theory)

go on datawrapper, you have the excel base file in Input folder
...
|:-------------:|:-------------:|
| Vaccine obbligation    |    -0,94 |
| Vaccine bad for health    | 0,36    | 
| Compliance to preventive behaviors |  0,35 |
| Trust in science | -0,23 |
| Endorsing conspiracy theories | 0,13 |
| Trust in health system | 0,13 |
| Approval of Government | -0,09 |
| Institutional trust | -0,09 |
| Trust in alternative medicine    |    0,06 |
"
